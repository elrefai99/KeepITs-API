...
This directory contains Docker configuration files for the KeepITs project. Below is a description of all Docker-related files in the project, including those in this directory and the project root.
